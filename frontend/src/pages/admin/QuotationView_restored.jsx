...
const QuotationView = ({ isPrintView = false }) => {
    ...
    useEffect(() => {
        if (isPrintView && data) {
            ...
            const shortTypes = {
                'Quincea├▒os': 'XV', 'Boda': 'Boda', 'Baby shower': 'BabyShower',
                'Aniversario': 'Aniversario', 'Corporativo': 'Corpo', 'Cumplea├▒os': 'Cumple'
            };
            ...
            const fileName = `${dateStr} ÔÇó ${tipoStr} ÔÇó ${numStr} ÔÇó ${clienteStr}`;
    ...
    if (!data) return <div className="quotation-empty">Cotizaci├│n no encontrada.</div>;
    ...
    const defaultPolicies = [
        'La vigencia de la oferta tiene un periodo de 15 d├¡as calendario a partir de su elaboraci├│n.',
        'Monto sujeto a cambio, seg├║n reajuste de precios a la fecha del Evento.',
    ...
    const formatTime = (timeStr) => {
        ...
        // Si ya viene formateada o es un formato extra├▒o, intentar parsear
        try {
    ...
    const handleWhatsAppShare = async () => {
        ...
        if (!phone) {
            Swal.fire({
                title: 'Atenci├│n',
                text: "No hay tel├®fono registrado para este cliente.",
                icon: 'warning',
        ...
        const message = `Hola ${cliente?.nombre || data?.cliente_nombre || 'Cliente'}, adjunto la cotizaci├│n para tu evento de ${data?.tipo_evento_nombre || 'Evento'} el d├¡a ${formatDateSafe(data?.fevent)}. Quedamos atentos a tus comentarios.`;
    ...
    return (
        <div className="quotation-view" style={brandStyles}>
                    ...
                    <div className="portCont_Info">
                        <header className="portInfCoti">
                            ...
                            <div className="infoBtnCoti">
                                <span style={{ color: '#ffffff' }}>{isArriendo ? 'Factura de Arriendo' : 'Cotizaci├│n Oficial'}</span>
                            </div>
                        ...
                        <p>Tu visi├│n, nuestra magia Ô£¿</p>
                    </div>
                </div>
            )}

            {/* Hoja carta 2 ÔÇó Sobre Nosotros (OCULTO EN ARRIENDOS) */}
            {!isArriendo && (
                <div className="quotation-page nosotros">
                    <div className="nosContIni">
                        ...
                        <div className="contDiv">
                            ...
                            <p className="nosInfo">
                                Somos expertos en la organizaci├│n de eventos con m├ís de 25 a├▒os de experiencia, especialistas como Wedding y Event Planner, creando y coordinando todo tipo de eventos, tanto sociales como corporativos a nivel local y nacional. Nos caracteriza un acompa├▒amiento humano y profesional, en el que nos involucramos cuidadosamente en cada detalle para comprender sus sue├▒os y expectativas, transform├índolos en experiencias ├║nicas, elegantes y memorables, cuidando cada detalle con responsabilidad, creatividad y pasi├│n. Con el objetivo fiel de dejar siempre en su excelencia.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="services-grid">
                        <div className="service-card scroll-reveal active" data-delay="150">
                            <div className="card-img">
                                <img alt="Bodas de Ensue├▒o" src="/images/home/bodas.png" />
                            </div>
                            <div className="card-body">
                                <span className="tag">Planificaci├│n</span>
                                <h3>Bodas de Ensue├▒o</h3>
                                <p>Planificaci├│n integral con un enfoque rom├íntico y arquitect├│nico.</p>
                            </div>
                        </div>
                        <div className="service-card scroll-reveal active" data-delay="150">
                            <div className="card-img">
                                <img alt="XV A├▒os" src="/images/home/quince.png" />
                            </div>
                            <div className="card-body">
                                <span className="tag">Celebraci├│n</span>
                                <h3>XV A├▒os</h3>
                                <p>Celebramos tu esencia con estilo, tendencia y sofisticaci├│n.</p>
                            </div>
                        </div>
                        <div className="service-card scroll-reveal active" data-delay="150">
                            <div className="card-img">
            ...
            {/* Hoja carta 3 ÔÇó Collage (OCULTO EN ARRIENDOS) */}
            {!isArriendo && (
                <div className={`quotation-page ${data?.tipo_evento === "Boda" ? "img-boda" : "img-otro"}`}>
                </div>
            )}

            {/* Hoja carta 4 ÔÇó Cotizaci├│n */}
            <div className="quotation-page cotizacion">
                            ...
                            <td>
                                <div className="quotation-content-flow">
                                    <div className="quotation-client">
                                        <div className="contInfoCoti">
                                            ...
                                            <div className="contInfoCoti__grid">
                                                ...
                                                <p><span>Tel├®fono:</span> {cliente.telefono || "No proporcionado"}</p>
                                            </div>
                                            <div className="contInfoCoti__grid">
                                                ...
                                                <div className="contInfoCoti__grid">
                                                    ...
                                                    <p>
                                                        ...
                                                        <div style={{ display: 'flex', gap: '6px', alignItems: 'center', marginTop: '4px' }}>
                                                            ...
                                                            }) : <span className="text-xs text-neutral-400">Ver tem├ítica</span>}
                                                        </div>
                                                    </p>
                                                </div>
                                            )}
                                    ...
                                    <div className="quotation-items-grid">
                                        {[[], []].map((colItems, colIdx) => {
                                            // L├│gica de balanceo simple para distribuir categor├¡as en dos columnas
                                    ...
                                    <div className="quotation-summary-area">
                                        <div className="terms-column">
                                            ...
                                            {isArriendo && data.notas_devolucion && (
                                                <div className="rental-notes mb-4">
                                                    <h4 className="terms-title">Notas de Devoluci├│n:</h4>
                                                    <p className="text-xs opacity-70 italic">{data.notas_devolucion}</p>
                                                </div>
                                            )}
                                            <h4 className="terms-title">T├®rminos & Condiciones:</h4>
                ...
                {/* Footer anclado al final de la p├ígina .cotizacion */}
            ...
            {/* Hoja carta 5 ÔÇó Adicionales (OCULTO EN ARRIENDOS) */}
            {!isArriendo && (
            ...
            {/* Hoja carta 6 ÔÇó Contacto (OCULTO EN ARRIENDOS) */}
            {!isArriendo && (
